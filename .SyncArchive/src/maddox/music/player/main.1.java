        ...
        public void onItemClick(AdapterView<?> arg0, View v, int arg2, long arg3)
        {
            ...
            if(tv.getText().toString().compareTo("Download") == 0)
            {
                ...
                if(index == 0)
                {
                    ...
                    dt.execute(new Integer[]{track.n,0});
                }
                if(index == 1)
                {
                    ...
                    DownloadTrack dt = new DownloadTrack();
                    dt.execute(new Integer[]{track.n,1});
                }
                if(index == 2)
                {
                    ...
                    DownloadTrack dt = new DownloadTrack();
                    dt.execute(new Integer[]{track.n,2});
                }
                if(index == 3)
                {
                    ...
                    DownloadTrack dt = new DownloadTrack();
                    dt.execute(new Integer[]{track.n,3});
                }
